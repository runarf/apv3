...
!(function (e) {
  ...
  var o = !1,
    ...
    d = [],
    u =
      a.requestAnimationFrame || a.webkitRequestAnimationFrame || a.mozRequestAnimationFrame || !1,
  ...
  var m = a.MutationObserver || a.WebKitMutationObserver || !1,
    ...
    b = function (e, p) {
      ...
      function z(e, o, t, r) {
        T.scrollrunning ||
          ((T.newscrolly = T.getScrollTop()), (T.newscrollx = T.getScrollLeft()), (D = f()));
        var i = f() - D;
        if (
          ((D = f()),
          i > 350 ? (A = 1) : (A += (2 - A) / 10),
          ...
          var s = e > 0 ? 1 : -1;
          X !== s &&
            (T.scrollmom && T.scrollmom.stop(), (T.newscrollx = T.getScrollLeft()), (X = s)),
            (T.lastdeltax -= e);
        }
        if (o) {
          if (
          ...
          var l = o > 0 ? 1 : -1;
          B !== l &&
            (T.scrollmom && T.scrollmom.stop(), (T.newscrolly = T.getScrollTop()), (B = l)),
            (T.lastdeltay -= o);
        }
        (o || e) &&
            ...
            if (
              ...
              T.railslocked ||
                T.rail.css({
                  ...
                  left: o.left,
                  height:
                    (e ? e.h : T.win.innerHeight()) - (M.railpadding.top + M.railpadding.bottom),
                }),
              T.zoom &&
                T.zoom.css({
                  top: o.top + 1,
        ...
        (this.init = function () {
          ...
          if ('IFRAME' == this.doc[0].nodeName) {
            var _ = function () {
              ...
              if (T.iframexd)
                return (
                  'console' in a && console.log('NiceScroll error: policy restriced iframe'), !0
                );
              if (
                ((T.forcescreen = !0),
                T.isiframe &&
      ...
      if (P.haseventlistener) {
        ...
        (Event.prototype.preventDefault = function () {
          ...
          (this.cancelEvent = function (e) {
            return (
              (e = e || a.event) && ((e.cancelBubble = !0), (e.cancel = !0), (e.returnValue = !1)),
              !1
            );
          }),
          (this.stopPropagation = function (e) {
      ...
      if (
        ...
        if (T.ishwscroll && P.hastransition && M.usetransition && M.smoothscroll) {
          ...
          (this.resetTransition = function () {
            ...
            (this.doScrollPos = function (e, o, t) {
              var r = T.getScrollTop(),
                i = T.getScrollLeft();
              if (
                (((T.newscrolly - r) * (o - r) < 0 || (T.newscrollx - i) * (e - i) < 0) &&
                  T.cancelScroll(),
                M.bouncescroll
                  ? (o < 0
                      ? (o = (o / 2) | 0)
                      : o > T.page.maxh && (o = (T.page.maxh + (o - T.page.maxh) / 2) | 0),
                    e < 0
                      ? (e = (e / 2) | 0)
          ...
          (this.doScrollLeft = function (e, o) {
            ...
            (this.cancelScroll = function () {
              return (
                T.timer && h(T.timer), (T.timer = 0), (T.bzscroll = !1), (T.scrollrunning = !1), T
              );
            });
      else
        (this.doScrollLeft = function (e, o) {
